...
public class DiaDia {
	...
	private boolean processaIstruzione(String istruzione) {
		FabricaDiComandi fabricaDiComandi = new FabricaDiComandiFisarmonica();
		Comando comandoDaEseguire = fabricaDiComandi.costruisciComando(istruzione, this.ioConsole);
