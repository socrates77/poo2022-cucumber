...
public class LabirintoBuilderTest {
	...
	public void testLabirintoBilocale() {
		...
		bilocale.setStanzaCorrente(bilocale.getStanzaCorrente().getStanzaAdiacente(Direzione.NORD));
	...
	public void testLabirintoTrilocale() {
		...
		trilocale.setStanzaCorrente(trilocale.getStanzaCorrente().getStanzaAdiacente(Direzione.NORD));
		assertEquals(new Stanza("cucina"), trilocale.getStanzaCorrente());
		trilocale.setStanzaCorrente(trilocale.getStanzaCorrente().getStanzaAdiacente(Direzione.EST));
